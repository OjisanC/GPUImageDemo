...
{
    self = [super initWithNibName:@"ShowcasePictureViewController" bundle:nil];
    if (self)
    {
...
- (void)setupFilter;
{
    gpuImagePicture = [[GPUImagePicture alloc] initWithImage:_inputImage];
    ...
    if (filterType == GPUIMAGE_FILECONFIG)
    {
        ...
        pipeline = [[GPUImageFilterPipeline alloc] initWithConfigurationFile:[[NSBundle mainBundle] URLForResource:@"SampleConfiguration" withExtension:@"plist"]
                                                                       input:gpuImagePicture output:(GPUImageView*)self.view];
    ...
    else
    {
       ...
       // videoCamera.runBenchmark = YES;
        ...
        if (filterType == GPUIMAGE_HISTOGRAM)
        {
            ...
            [gpuImagePicture addTarget:gammaFilter];
            ...
            [gpuImagePicture addTarget:blendFilter];
        ...
        else if ( (filterType == GPUIMAGE_SPHEREREFRACTION) || (filterType == GPUIMAGE_GLASSSPHERE) )
        {
            ...
            [gpuImagePicture addTarget:gaussianBlur];
...
- (IBAction)updateFilterFromSlider:(id)sender;
{
    ...
    switch(filterType)
    {
        ...
        case GPUIMAGE_HIGHLIGHTSHADOW: [(GPUImageHighlightShadowFilter *)filter setShadows:[(UISlider *)sender value]]; break;
...
- (void)grepFacesForSampleBuffer:(CMSampleBufferRef)sampleBuffer{
    ...
    AVCaptureDevicePosition currentCameraPosition = AVCaptureDevicePositionBack;//[videoCamera cameraPosition];
